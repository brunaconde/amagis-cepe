  ...
  const weeks = [
    ...
    },
    {
      ...
      activities: [
        ...
        "Sexta: Curso + Visita ao Plaza Cielo y Tierra + Entrega de certificados para alunos de 2 semanas",
        "Sábado: Dia livre - passeios opcionais",
      ],
    },
    {
      ...
      activities: [
        ...
        "Sexta: Exame oral e entrega de certificados para alunos de 3 semanas",
