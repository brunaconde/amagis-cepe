    ...
    <section className="section-padding bg-background" id="porque">
      <div className="section-container">
        <div className="text-center mb-16">
          <h2 className="heading-lg text-foreground mb-4">Por que Córdoba e CEPE Idiomas?</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground mb-4">
              Conhecida como <strong className="text-foreground">"La Docta"</strong> pela sua efervescência
              universitária e cultural, Córdoba é um caldeirão cultural no coração da Argentina.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Cidade ideal para quem busca uma imersão autêntica e segura, perfeita para aprender e se divertir.",
                },
                {
                  icon: Coffee,
                  title: "Cultura Rica",
                  description:
                    "Cafés, música, arte e tradições argentinas que tornam cada momento uma experiência inesquecível.",
                },
              ].map((item, index) => (
                <div
                  key={index}
                  className="flex gap-4 p-4 bg-card rounded-xl border border-border hover:shadow-soft transition-shadow"
                >
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground mb-4">
              Nossa escola, localizada no coração de Córdoba, oferece{" "}
              <strong className="text-foreground">metodologia dinâmica</strong> e professores dedicados que transformam
              o aprendizado em uma experiência leve e eficaz.
            </p>
              ...
              {[
                {
                  ...
                  description:
                    "Ambiente perfeito para desenvolver suas habilidades enquanto desfruta da cultura argentina.",
                },
                {
                  icon: Globe,
