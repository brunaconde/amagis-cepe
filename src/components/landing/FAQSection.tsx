...
const FAQSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Sim, os 15% de desconto são válidos sobre o valor tabelado de o programa de intercâmbio do CEPE Idiomas, seja qual for a duração (2, 3 ou 4 semanas).",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Após o preenchimento do formulário, nossa equipe entrará em contato para verificar sua elegibilidade e aplicar o desconto de 15% automaticamente sobre o valor tabelado do programa de intercâmbio.",
    },
    {
      question: "O que está incluso no programa de intercâmbio?",
      answer:
        "Nossos programas incluem aulas intensivas de idiomas e diversas atividades culturais complementares. Acomodação, passagens aéreas e seguro-viagem não estão inclusos, mas podem ser cotados separadamente.",
    },
    {
      question: "Preciso de visto para a Argentina?",
      answer:
        "Para cidadãos brasileiros, não é necessário visto para programas de intercâmbio de curta duração na Argentina. Apenas seu RG (com até 10 anos de emissão e boa foto) ou passaporte válido são documentos suficientes para entrada.",
    },
    {
      question: "Posso levar minha família?",
      answer:
        "Sim! O desconto é extensivo a dependentes da AMAGIS. Converse com nossa equipe para planejar a melhor experiência de intercâmbio para toda a família.",
    },
    {
      question: "Como faço o teste de nivelamento?",
      answer:
        'Basta clicar no botão "Fazer Teste Gratuito de Espanhol!" e responder às questões. O resultado será enviado por e-mail e nos ajudará a personalizar seu curso no CEPE Idiomas.',
    },
    {
      question: "Quais são os custos adicionais?",
      answer:
        "Passagens aéreas, seguro-viagem, alimentação, passeios extras e acomodação são custos adicionais que podem ser cotados pela nossa equipe de acordo com suas preferências.",
    },
    {
